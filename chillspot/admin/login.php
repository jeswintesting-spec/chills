...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($row['password'] === $password) {
        ...
        if ($admin_number === 'admincanteen') {
            header("Location: admincanteen.html");
        } elseif ($admin_number === 'adminlibrary') {
            header("Location: libraryadmin.html");
        } elseif ($admin_number === 'sportshubadmin') {
            header("Location: sportshubadmin.html");
        } elseif ($admin_number === 'eventsadmin') {
            header("Location: eventsadmin.html");
        } elseif ($admin_number === 'labadmin') {
            header("Location: labadmin.html");
